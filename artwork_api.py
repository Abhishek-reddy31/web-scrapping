...
CHROME_DRIVER_PATH = 'C:/Users/Abhishek Reddy/.cache/selenium/chromedriver/win64/124.0.6367.91/chromedriver.exe'
...
def get_artwork():
    ...
    if not artwork_name or not artist_name:
        return jsonify({"error": "Please provide both artwork name and artist name"}), 400
